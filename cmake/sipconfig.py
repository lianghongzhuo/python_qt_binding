...
_pkg_config = {
    ...
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/usr/include/python3.10',
    'py_inc_dir':         '/usr/include/python3.10',
    'py_lib_dir':         '/usr/lib/python3.10/config',
    'py_version':         0x030a03,
    'qt_framework':       0,
    'sip_bin':            '/usr/bin/sip',
    'sip_config_args':    '--destdir /usr/lib/python3/dist-packages --debug --no-dist-info CFLAGS=-g -O2 -ffile-prefix-map=/build/sip4-hek6ei/sip4-4.19.25+dfsg=. -flto=auto -ffat-lto-objects -flto=auto -ffat-lto-objects -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 CXXFLAGS=-g -O2 -ffile-prefix-map=/build/sip4-hek6ei/sip4-4.19.25+dfsg=. -flto=auto -ffat-lto-objects -flto=auto -ffat-lto-objects -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 LFLAGS=-Wl,-Bsymbolic-functions -flto=auto -ffat-lto-objects -flto=auto -Wl,-z,relro',
    'sip_inc_dir':        '/usr/include/python3.10',
...
_default_macros = {
    ...
    'AR':                       'ar cqs',
    'CC':                       'gcc',
    'CFLAGS':                   '-g -O2 -ffile-prefix-map=/build/sip4-hek6ei/sip4-4.19.25+dfsg=. -flto=auto -ffat-lto-objects -flto=auto -ffat-lto-objects -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2',
    'CFLAGS_APP':               '',
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    ...
    'COPY':                     'cp -f',
    'CXX':                      'g++',
    'CXXFLAGS':                 '-g -O2 -ffile-prefix-map=/build/sip4-hek6ei/sip4-4.19.25+dfsg=. -flto=auto -ffat-lto-objects -flto=auto -ffat-lto-objects -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '',
    'CXXFLAGS_DEBUG':           '-g',
    ...
    'LFLAGS':                   '-Wl,-Bsymbolic-functions -flto=auto -ffat-lto-objects -flto=auto -Wl,-z,relro',
    'LFLAGS_CONSOLE':           '',
    'LFLAGS_CONSOLE_DLL':       '',
    'LFLAGS_DEBUG':             '',
    'LFLAGS_DLL':               '',
